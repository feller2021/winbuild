...
if __name__ == '__main__':
    ...
    pinjiexiazai=os.environ["pinjiexiazai"]
 
 
 
    pinjiexiazai2=pinjiexiazai+fgfg
 
    title = 'ISO完成构建 %s' % time.strftime('%H:%M:%S')
    content = 'ISO完成构建时间： %s' % time.strftime('%H:%M:%S')+'<br/>'+pinjiexiazai2
    send_mail(['1449621606@qq.com'], title, content, ['1181259728@qq.com'],  'utf-8', True)
