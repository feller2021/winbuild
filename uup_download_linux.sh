#!/bin/bash
#Generated on 2023-03-22 03:06:08 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=2326143b-ab3d-484a-90aa-3bc64e1a7c0c&pack=zh-cn&edition=corecountryspecific;professional&aria2=2"
if [ $? != 0 ]; then
